...
export const searchMeds = functions.https.onRequest((req, res) => {
...
export const getMedication = functions.https.onRequest((req, res) => {
  corsHandler(req, res, async () => {
    try {
...
export const checkDrugInteraction = functions.https.onRequest((req, res) => {
  corsHandler(req, res, async () => {
    try {
      // Only allow POST
      if (req.method !== 'POST') {
...
export const askHealthDose = functions.https.onRequest((req, res) => {
...
// ===========================================
// TEST RAG ENDPOINT (for quick testing)
// ===========================================

export const testRag = functions.https.onRequest((req, res) => {
  // Set CORS headers
  res.set('Access-Control-Allow-Origin', '*');
