    ...
    <div className="min-h-screen py-8 px-4">
      ...
      */}
        ...
        */}
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Click the buttons to change the count. This demonstrates React 
              state management - when count changes, the UI updates automatically!
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm font-mono">
              <div>
                ...
                <ul className="space-y-1 text-muted-foreground">
                  <li>|-- web/ <span className="text-xs">(this React app)</span></li>
                  <li>|-- functions/ <span className="text-xs">(tRPC backend)</span></li>
                </ul>
              </div>
              <div>
                <h4 className="font-bold text-primary mb-2">packages/</h4>
                <ul className="space-y-1 text-muted-foreground">
                  <li>|-- ui/ <span className="text-xs">(shared components)</span></li>
                  <li>|-- shared/ <span className="text-xs">(Zod schemas)</span></li>
                  <li>|-- config/ <span className="text-xs">(TypeScript config)</span></li>
                </ul>
              </div>
            </div>
          </CardContent>
      ...
      <p className="text-center text-muted-foreground mt-8 text-sm">
        Edit <code className="bg-muted px-1 rounded">apps/web/src/App.tsx</code> and save to see hot reload in action!
      </p>
    </div>
  )
}
